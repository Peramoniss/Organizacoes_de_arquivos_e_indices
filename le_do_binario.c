...
int height(node *
    const root);
int pathToLeaves(node *
    const root, node * child);
void printLeaves(node *
    const root);
void printTree(node *
    const root);
void findAndPrint(node *
    const root, int key, bool verbose, int limit);
void findAndPrintRange(node *
    const root, int range1, int range2, bool verbose, int limit);
int findRange(node *
    const root, int key_start, int key_end, bool verbose,
        int returned_keys[], void * returned_pointers[]);
node * findLeaf(node *
    const root, int key, bool verbose);
...
void findAndPrintRange(node *
    const root, int key_start, int key_end,
